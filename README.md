# LovyanGFX_ClockSample
Example Usage of LovyanGFX library for VIDI X Microcomputer
...
2. Type ```LovyanGFX``` into the search box.
3. Click the row to select the library.
4. Click the ```Install``` button to install the library.
5. Click "File-> Examples". Here are some test programs in "LovyanGFX->"


### Using Library

1. Open any examples sketch
2. After second #include line of code add the folowing configuration
...
// SPIバスの設定
    ...
    //cfg.offset_rotation  =     0;  // 1 - Horizontal LCD Display Orentation, 0 - Vertical LCD Display Orentation
