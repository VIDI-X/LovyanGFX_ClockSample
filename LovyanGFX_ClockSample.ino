...
// SPIバスの設定
    ...
    //cfg.offset_rotation  =     0;  // 1 - Horizontlan ekran, 0 - Vertikalan ekran,
...
static uint64_t count = (ss * 1000) + (mm * 60 * 1000) + (hh * 60 * 60 * 1000);
...
void loop(void)
{
  ...
  //canvas.setPaletteColor(0, 255, 0, 0); // 
  //canvas.setPaletteColor(15, 255, 0, 0); // velike kazaljke i brojevi
  canvas.setPaletteColor(14, 255, 0, 0); // aktualna toćka sekundi
  //canvas.setPaletteColor(13, 0, 0, 255); // sjena senkundera
  canvas.setPaletteColor(12, 0, 255, 0); // 7 segment i točkice
  //canvas.setPaletteColor(11, 0, 255, 0); // sjenica
  //canvas.setPaletteColor(10, 0, 255, 0); // opet neka sjenica 
  //canvas.setPaletteColor(9, 0, 255, 0); // sjena sekundera
  canvas.setPaletteColor(8, 255, 0, 0); // sekunder
  canvas.setPaletteColor(7, 0, 255, 0); // sjenica velikih kazaljki
  canvas.setPaletteColor(6, 0, 25, 0); // pozadina
  canvas.setPaletteColor(5, 0, 5, 0); // pozadina 7segmnt displaya
  //canvas.setPaletteColor(4, 0, 255, 0); // sjenica točkica kazaljki
  //canvas.setPaletteColor(3, 0, 255, 0); //  sjenica sekunder kazaljki
  //canvas.setPaletteColor(2, 0, 255, 0); // sjenica velikih kazaljki
  //canvas.setPaletteColor(1, 0, 255, 0); //  sjena velikih kazaljki i brojeva
  //0xFF0000U
//count += 60000;
